    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header headerRegister">
          <h5 class="modal-title" id="titleModal">Nuevo importe seguro</h5>
              ...
              <div class="tile-body">                
                <form class="form-horizontal" id="formDefault">    
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="nombre" name="nombre" type="text" required=""  title="Nombre">    
                  </div> 
                  <div class="control-group-inline">
                   <label for="vigenciadesde">Vigencia desde</label>
                    ...
                    <label for="vigenciahasta" style="padding-left: 15px">Vigencia hasta</label>
                    <i class="fa fa-calendar"></i>
