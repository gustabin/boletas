    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header headerRegister">
          <h5 class="modal-title" id="titleModal">Nueva tasa de interes</h5>
          ...
          <div class="tile">            
              <div class="tile-body">                
                <form class="form-horizontal" id="formDefault">   
                  ...
                  <div class="form-group">
                   <label for="fechaalta">Vigencia desde</label>
                    <i class="fa fa-calendar"></i>
                    <input type="text"  id="vigenciadesde" name="vigenciadesde" class="form-control required vigenciadesde" maxlength="20" style="width: 100px" title="Vigencia desde" />                    
                  </div>   
                  <div class="form-group">
                   <label for="fechaalta">Vigencia hasta</label>
                    <i class="fa fa-calendar"></i>
                    <input type="text"  id="vigenciahasta" name="vigenciahasta" class="form-control required vigenciahasta" maxlength="20" style="width: 100px" title="Vigencia hasta" />                    
                  </div>   
                  <div class="form-group">
                    <label class="control-label">Porcentaje</label>
                    <input class="form-control" id="porcentaje" name="porcentaje" type="text" required=""  onkeypress="return isNumberKey(event)" title="Importe">   
                  </div>    
