...
if($option=="incluir"){ 
  ...
  if($_SESSION['token'] == $token){
      ...
      $sql = "INSERT INTO `seccional` (`id`, `idsindicato`, `nombre`, `fecha`, `status`) VALUES (NULL, $idsindicato, '$nombre', NOW(), $status)";
...
if($option=="consultar"){
  ...
  if($_SESSION['token'] == $token){
      ...
      $sql = "SELECT * FROM seccional WHERE id = $clave";
...
if($option=="modificar"){  
  ...
  if($_SESSION['token'] == $token){
      ...
      while($data=mysqli_fetch_array($result))
        ...
        if(!empty($id))
        {
            $sql = "UPDATE seccional SET idsindicato = '$idsindicato', nombre = '$nombre', 
...
if($option=="eliminar"){
  ...
  if($_SESSION['token'] == $token){
      ...
      $sql = "DELETE FROM seccional WHERE id = $clave";
      if (mysqli_query($conn, $sql)) {
