    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header headerRegister">
          <h5 class="modal-title" id="titleModal">Nuevo sindicato</h5>
        ...
        <div class="modal-body"> 
          <div class="tile">            
              <div class="tile-body">                
                <form class="form-horizontal" id="formDefault" accept-charset="utf-8"> 
                  <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">           
                  <input type="hidden" name="id" id="id" value="">
                  <div class="form-group">
                    <label class="control-label">Cuit</label>
                    <input class="form-control" id="cuit" name="cuit" type="text" placeholder="Cuit" required="" maxlength="11">
                  </div>  
                  <div class="form-group">
                    <label class="control-label">Razón social</label>
                    <input class="form-control" id="razonsocial" name="razonsocial" type="text" placeholder="Razón social" required="" maxlength="300">
                  </div>     
                  <div class="form-group">
                    <label class="control-label">Dirección</label>
                    <input class="form-control" id="direccion" name="direccion" type="text" placeholder="Dirección" required="" maxlength="100">
                  </div> 
                  <div class="form-group">
