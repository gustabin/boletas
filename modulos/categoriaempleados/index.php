...
if($_SESSION['acceso3'] !== 'CategoriaEmpleados'){
...
$page_title = "Categoria de empleados";
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
      <div class="content-wrapper">
          ...
          <?php include_once('categoriaempleadosModal.php'); ?>
              ...
              <div class="row">
                <div class="col-12">            
                  <div class="card">
                    ...
                    <div class="card-body">
                      <?php include_once('categoriaempleadosTabla.php'); ?>
                    </div>
                  </div>
                </div>
              </div>
